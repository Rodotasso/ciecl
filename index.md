...
¿No sabes cuál función usar?
[`cie_guide()`](https://rodotasso.github.io/ciecl/reference/cie_guide.md)
muestra una tabla comparativa con el escenario, la función recomendada y
...
necesitas credenciales gratuitas de la OMS
...
![Grupo de Ciencia de Datos para Salud
Pública](reference/figures/logo-CDSP_color.png)
