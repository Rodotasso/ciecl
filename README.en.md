...
prints a comparison table with the scenario, the recommended function,
and an example for each case.
...
you need free WHO credentials (<https://icd.who.int/icdapi>). We
