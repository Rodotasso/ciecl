...
The ICD-10 codes included in `ciecl` are established by Chilean Decree
356/2017 (Ministry of Health) as the official disease classification
...
and access the updated international classification, you need free WHO
credentials:
...
guide](https://rodotasso.github.io/ciecl/CONTRIBUTING.md) before
submitting changes.
...
Conduct](https://rodotasso.github.io/ciecl/CODE_OF_CONDUCT.md). By
...
Group](reference/figures/logo-CDSP_color.png)
