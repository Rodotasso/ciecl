...
> **Language / Idioma:** [English](https://github.com/RodoTasso/ciecl/blob/main/README.md) | **Español**
...
Paquete especializado para búsqueda, validación y análisis de códigos CIE-10 en el contexto chileno. Incluye 39,877 códigos (categorías y subcategorías) con búsqueda optimizada, cálculo de comorbilidades y acceso a la API CIE-11 de la OMS.
...
- **39,877 códigos CIE-10**: Incluye todas las categorías (3 dígitos) y subcategorías (4+ dígitos)
- **Búsqueda fuzzy**: Algoritmo Jaro-Winkler para tolerar errores de escritura
...
- **Dependencias minimas**: Solo 8 paquetes requeridos para funcionalidad core
...
- **Repositorio de documentos**: <https://deis.minsal.cl>
