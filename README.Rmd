...
**Nota**: El paquete tiene **dependencias mínimas** para funcionalidad core. Paquetes adicionales solo se requieren para funciones específicas. Ver [dev/DEPENDENCIAS.md](dev/DEPENDENCIAS.md) para detalles.
