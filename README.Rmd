...
> **Language / Idioma:** **English** | [Español](https://github.com/RodoTasso/ciecl/blob/main/README.es.md)
...
- Hierarchical expansion of categories to subcategories
  (e.g., E11 -> E11.0, E11.1, ..., E11.9)

## Why use ciecl

### Advantages:

1.  **Performance**: SQLite indexed database with 10-100x faster searches
    than Excel
...
6.  **No encoding errors**: XLSX files have issues with accents on different
    systems
7.  **Reproducibility**: Version-controlled ICD-10 catalog (doesn't change
    between computers)
...
The ICD-10 codes included in `ciecl` are established by Decree 356/2017 of Chile's Ministry of Health as the official disease classification system. The dataset is not modifiable by the package — it can only be updated by institutional decree from MINSAL through DEIS.
...
ICD-10 data is for public use according to
[Decree 356 Exempt (2017)](https://www.bcn.cl/leychile/navegar?i=1112064)
