...
`cie11_search()` consulta la API oficial de la OMS y permite especificar el
idioma, ya que el servidor de la OMS ofrece traducciones oficiales. En `ciecl`
se expone el parámetro `lang = "es"` (por defecto) o `lang = "en"`.
...
> Nota: esta sección requiere credenciales de la API OMS. Consulta la vignette
> [Guía de Instalación y Configuración](instalacion.html) para aprender a
> guardarlas de forma segura utilizando `keyring`.
